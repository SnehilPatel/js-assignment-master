...
-- Add news tables
CREATE TABLE IF NOT EXISTS mydb.match_news (
...
CREATE TABLE IF NOT EXISTS mydb.tour_news (
    id INT AUTO_INCREMENT PRIMARY KEY,
    tourId INT NOT NULL,
    title VARCHAR(255) NOT NULL,
    description TEXT NOT NULL,
...
-- Add sportId to match_news
ALTER TABLE match_news
ADD COLUMN sportId INT NOT NULL,
